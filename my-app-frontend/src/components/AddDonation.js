        ...
        <>
            <Form onSubmit={handleSubmit}>
                ...
                <FloatingLabel controlId="floatingSelect">
                    <Form.Select aria-label="Floating label select example">
                        ...
                        {categories.map((categorie) =>
                            <option name="categorie_id" value={categorie.id} key={categorie.id} >{categorie.name}</option>
                        )}
                ...
                <FloatingLabel
                    ...
                    className="mb-3"
                >
                    <Form.Control as="textarea" placeholder="Leave a comment here" name="comment" />
                </FloatingLabel>
                </Col>
                </Row>
                <Row>
